...
student_1 = Student('Tonny', 'Montana', 'Male')
...
lecturer_1 = Lecturer('Richard', 'Ivanov')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Elon', 'Mask')
lecturer_2.courses_attached += ['Python']


reviewer_1 = Reviewer('Tom', 'Cruze')
reviewer_1.courses_attached += ['Python']

reviewer_2 = Reviewer('Zaha', 'Hadid')
...
student_1.rate_lect(lecturer_1, 'Python', 6)
